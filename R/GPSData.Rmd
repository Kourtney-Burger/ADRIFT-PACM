...
PACM_GPS$UNIQUE_ID <- paste0('SWFSC_', 'NEPac-', deployDetails$Site, '_', deployDetails$Month_Yr_PACMID, '_', PACM_GPS$UNIQUE_ID)
```
...
write.csv(PACM_GPS, "~/GitHub/ADRIFT-PACM/PACM Worksheets/SWFSC_20240410_GPSDATA.csv", row.names=FALSE)
```
